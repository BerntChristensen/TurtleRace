...
En förbättring hade varit att använda en vektor istället för att dynamiskt kunna bestämma antalet sköldpaddor. En referens till varje sköldpadda skulle finnas i vektorn. Under loppet hade vi vid varje steg itererat över alla sköldpaddor och flyttat dessa framåt.
